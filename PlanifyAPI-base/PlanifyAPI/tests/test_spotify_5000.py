...
def create_caller():
    ...
    rate_spotify = api_call_spotify.get_calls_per_second(5000, timedelta(hours=1))

    print(
        f"""La cuota a cumplir es de 5000 cada 1 hora. Por ello, se realizarán {rate_spotify} llamadas por segundo."""
    )
