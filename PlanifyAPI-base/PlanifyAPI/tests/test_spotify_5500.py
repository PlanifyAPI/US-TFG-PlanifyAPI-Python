...
rate_spotify = api_call_spotify.get_calls_per_second(5500, timedelta(hours=1))

print(
    f"""La cuota a cumplir es de 5500 cada 1 hora. Por ello, se realizarán {rate_spotify} llamadas por segundo."""
)
